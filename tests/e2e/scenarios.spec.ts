...
test('Verify successful checkout after adding product to cart from products page using Info section', async ({ authPom }) => {
...
test('Verify successful checkout after adding product to cart from products page using Overlay section', async ({ authPom }) => {
    await step('Open the home page', async () => {
        await authPom.homePage.navigateToHomePage();
        await authPom.homePage.assertPageLoaded();
    });
